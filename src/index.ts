...
export { resolveTheme, themes, registerTheme, getTheme, listThemes, dracula, nord, monokai, amber, greenPhosphor, cyberpunk, solarizedDark, win95, catppuccin, tokyoNight, gruvbox, highContrast, modusVivendi, oxocarbon, rosePine, everforest, kanagawa, flexoki, githubLight, dayfox } from './themes/index.js';
